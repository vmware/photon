...
* [Allowed JSON Fields](#allowed-json-fields)
...
<p> <b>crypted: false:</b>
This indicates that the "text" field is plain text. It wis then encrypted and used to create the root user's password.
