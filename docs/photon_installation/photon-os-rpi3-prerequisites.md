...
<p>2. Software utilities to flash an image onto an SD-card (details and instructions provided below).</td>
	...
	<td>Photon OS RPi3 image downloaded from <a href="https://packages.vmware.com/photon/3.0/Beta/rpi3">rpi3</a> <br> 
...
1. Download Photon OS. 
    ...
    **Note**: You cannot use the Photon ISO to install on RPi3. 
    ...
    Go to the following https://packages.vmware.com/photon URL and download the latest release of Photon OS image for RPi3: [https://packages.vmware.com/photon/3.0/Beta/rpi3](https://packages.vmware.com/photon/3.0/Beta/rpi3). 
