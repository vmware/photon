...
For locally logged-on users, Photon OS 2.0 provides a command line interface to manage network configuration of the system.

- [Setup Steps](#setup-steps)
- [Syntax](#syntax)
- [Network Manager CLI](#network-management)

# Setup Steps

The netmgr tool is included with your Photon OS 2.0 distribution. To make sure that you have the latest version, you can run:
~~~~
