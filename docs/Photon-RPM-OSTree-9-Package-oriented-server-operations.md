...
baseurl=https://packages.vmware.com/photon/1.0/photon_release_1.0_x86_64
...
So what's in an RPMS repository? If we point the browser to https://packages.vmware.com/photon/1.0/photon_release_1.0_x86_64, we can see there are three top directories:
