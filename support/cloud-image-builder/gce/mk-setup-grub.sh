...
menuentry 'GNU/Linux' --class gnu-linux --class gnu --class os $menuentry_id_option 'gnulinux-simple-UUID_PLACEHOLDER' {
    ...
    echo    'Loading Linux 3.19.2 ...'
    linux   /boot/vmlinuz-3.19.2 root=/dev/sda2 ro console=ttyS0,38400n8 
}
submenu 'Advanced options for GNU/Linux' $menuentry_id_option 'gnulinux-advanced-UUID_PLACEHOLDER' {
    menuentry 'GNU/Linux, with Linux 3.19.2' --class gnu-linux --class gnu --class os $menuentry_id_option 'gnulinux-3.19.2-advanced-UUID_PLACEHOLDER' {
        load_video
        set gfxpayload=keep
        insmod gzio
        insmod part_msdos
    ...
    menuentry 'GNU/Linux, with Linux 3.19.2 (recovery mode)' --class gnu-linux --class gnu --class os $menuentry_id_option 'gnulinux-3.19.2-recovery-UUID_PLACEHOLDER' {
        load_video
        set gfxpayload=keep
        insmod gzio
        insmod part_msdos
        ...
        echo    'Loading Linux 3.19.2 ...'
        linux   /boot/vmlinuz-3.19.2 root=/dev/sda2 ro single console=ttyS0,38400n8
    }
}
