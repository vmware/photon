...
qemu-img convert -f raw -O vmdk -o adapter_type=lsilogic,subformat=streamOptimized $PHOTON_IMG_OUTPUT_PATH/photon-ova.raw $PHOTON_IMG_OUTPUT_PATH/photon-ova.vmdk
