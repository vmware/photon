...
if [ $# -eq 2 ]; then
   ...
   cat xrpmfilelist | awk '{print "https://packages.vmware.com/photon/photon_publish_x_rpms/"$1}' | xargs -n 1 -P 10 wget --user-agent Mozilla/4.0 -c -nv -nc -r -nH --cut-dirs=4 -P ${PUBLISHRPMSPATHDIR}
fi
