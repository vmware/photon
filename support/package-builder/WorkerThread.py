...
class WorkerThread(threading.Thread):
    ...
    def __init__(self, event, name, mapPackageToCycle,
                 listAvailableCyclicPackages,
                 logger, listBuildOptionPackages, pkgBuildOptionFile,
                 pkgBuildType):
    ...
    def run(self):
        ...
        while True:
            ...
            if pkg not in outputMap or outputMap[pkg] == False:
                ...
                break
            self.logger.info("Thread " + self.name + " finished building package:" +
                             pkg)
