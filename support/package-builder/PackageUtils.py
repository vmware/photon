...
class PackageUtils(object):
    ...
    def buildRPMSForGivenPackage(self, sandbox, package, version, destLogPath):
        ...
        self.logger.info("Extra macros for " + package + ": " + str(macros))
        self.logger.info("Extra source URLs for " + package + ": " + str(sources_urls))
    ...
    def _getAdditionalBuildOptions(self, package):
        pullsources_urls = []
        macros = []
        self.logger.info("Package: "+str(package)+" key: "+str(constants.buildOptions.keys()))
