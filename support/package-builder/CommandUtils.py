...
class CommandUtils:
    ...
    def findFile(filename, sourcePath):
        ...
        processSort = subprocess.Popen(["sort",  "-d"], stdin=process.stdout, stdout=subprocess.PIPE)
        process.stdout.close() # Allow process to receive a SIGPIPE if processSort exits.
        processSort.wait()
