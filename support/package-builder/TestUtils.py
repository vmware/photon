...
class TestUtils(object):
    ...
    def installTestRPMS(self, package, chrootID):
        ...
        self.logger.debug("Installing rpms for TEST: "+packages)
    ...
    def copyRPMfromBintray(self, package, rpmdirPath):
        ...
        for rpms in contents:
            ...
            urllib.URLopener().retrieve(self.bintrayx86_64URL+"/"+ rpmName, rpmName)
        ...
        for rpms in contents:
            ...
            self.logger.info("Downloading PUBLISHEDRPM " +  rpmName + "....")
            urllib.URLopener().retrieve(self.bintraynoarchURL+"/"+ rpmName, rpmName)
