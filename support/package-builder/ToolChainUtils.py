...
class ToolChainUtils(object):
    ...
    def getListDependentPackageLineContent(self, index):
        listBuildRequiresPkgLineContent=SPECS.getData().getBuildRequiresLineContentForPackage(self.package, index)
        listBuildRequiresPkgLineContent.extend(SPECS.getData().getCheckBuildRequiresLineContentForPackage(self.package, index))
        listBuildRequiresPkgLineContent=list(set(listBuildRequiresPkgLineContent))
        listRequiresPkgLineContent = SPECS.getData().getRequiresLineContentForPackage(self.package,index)
