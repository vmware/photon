...
class BuildContainer(object):
    ...
    def prepareBuildContainer(self, containerTaskName, packageName, isToolChainPackage=False):
        ...
        mountVols = {
                        ...
                        constants.rpmPath: {'bind': '/rpms', 'mode': 'ro'},
                    }
    ...
    def buildPackage(self, package):
        ...
        try:
            ...
            if package in constants.perPackageToolChain:
                ...
                pkgUtils.installCustomToolChainRPMS(containerID, constants.perPackageToolChain[package], package);
            ...
            if len(listDependentPackages) != 0:
                self.logger.debug("VDBG-BC-buildPackage: Pkg " + package + "BuildTimeRequired listDependentPackages: ")
                ...
                self.logger.debug("VDBG-BC-buildPackage: Finished installPackage. New listInstalledPackages: ")
    ...
    def installDependentRunTimePackages(self, pkgUtils, package, containerID, destLogPath, listInstalledPackages, listInstalledRPMs):
        self.logger.info("VDBG-BC-installDependentRunTimePackages: package: " + package)
        ...
        if len(listRunTimeDependentPackages) != 0:
            for pkg in listRunTimeDependentPackages:
                ...
                self.logger.info("VDBG-BC-installDependentRunTimePackages: package: " + package + ", latestPkgRPM: " + latestPkgRPM)
