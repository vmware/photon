...
def main():
    ...
    parser.add_argument("-o",  "--build-option", dest="buildOption",  default="full")
    parser.add_argument("-z",  "--top-dir-path", dest="topDirPath",  default="/usr/src/photon")
    parser.add_argument("-j",  "--json-file", dest="inputJSONFile",  default="../../common/data/build_install_options_all.json")
    parser.add_argument("-b",  "--build-root-path", dest="buildRootPath",  default="/mnt")
    parser.add_argument("-t",  "--threads", dest="buildThreads", type=int, default=1, help="Number of working threads")
    ...
    parser.add_argument("-w",  "--pkginfo-file",  dest="pkgInfoFile",  default="../../common/data/pkg_info.json")
