...
/sbin/ldconfig
[ $1 = 1 ] || exit 0
echo "using empty dict to provide pw_dict"
...
[ $2 = 1 ] || exit 0
echo "detected cracklib-dicts install"
echo "switching pw_dict to cracklib-dicts"
...
[ $2 = 0 ] || exit 0
echo "detected cracklib-dicts uninstall"
echo "switching pw_dict to empty dict"
ln -sf empty.hwm %{_datadir}/cracklib/pw_dict.hwm
ln -sf empty.pwd %{_datadir}/cracklib/pw_dict.pwd
ln -sf empty.pwi %{_datadir}/cracklib/pw_dict.pwi
