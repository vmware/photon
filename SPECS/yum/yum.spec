...
Patch1:         parser.patch
Patch2:         yum-CVE-2013-1910.patch
...
# install -m 755 %{SOURCE2} %{buildroot}/etc/cron.daily/yum.cron

# Ghost files:
mkdir -p %{buildroot}/var/lib/yum/history \
        %{buildroot}/var/lib/yum/plugins \
        %{buildroot}/var/lib/yum/yumdb
...
%changelog
* Tue Nov 12 2019 Satya Naga Vasamsetty <svasamsetty@vmware.com> 3.4.3-8
- Fix CVE-2013-1910
