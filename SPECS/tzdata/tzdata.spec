...
%define sha512 %{name}=7f79394295e00e3a24ebdbf9af3bc454a65f432a93b517e7e96c7f9db9949f6f5fdae9892a9d3789ff44ae0eb1bfe4744d36976b4624659af951d26414f94e65
...
%install
cd %{blddir}
ZONEINFO=%{buildroot}%{_datadir}/zoneinfo
...
ln -svf %{_datadir}/zoneinfo/UTC %{buildroot}%{_sysconfdir}/localtime
