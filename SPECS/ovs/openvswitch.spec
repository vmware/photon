...
%{_libdir}/%{_unitdir}/openvswitch.service
%{_libdir}/%{_unitdir}/ovs-vswitchd.service
%{_libdir}/%{_unitdir}/ovsdb-server.service
%{_libdir}/lib*
...
%files -n ovn-host
%{_libdir}/%{_unitdir}/ovn-controller.service
%{_bindir}/ovn-controller

%files -n ovn-central
%{_libdir}/%{_unitdir}/ovn-northd.service
%{_bindir}/ovn-northd
%{_datadir}/openvswitch/ovn-nb.ovsschema
%{_datadir}/openvswitch/ovn-sb.ovsschema

%files -n ovn-controller-vtep
%{_libdir}/%{_unitdir}/ovn-controller-vtep.service
