...
%changelog
* Fri Aug 07 2026 Daniel Casota <dcasota@gmail.com> 0.19.0-3
- Ship tini-static in a new subpackage and restore tini-disable-git.patch so the version suffix is not dropped
