...
%changelog
* Mon Jun 15 2026 Brennan Lamoreaux <brennan.lamoreaux@broadcom.com> 2.8.2-17
...
- Bump up version as a part of samba-client upgrade
* Thu Oct 19 2023 Brennan Lamoreaux <blamoreaux@vmware.com> 2.8.2-9
- Remove post install/uninstall actions
* Mon Jul 31 2023 Oliver Kurth <okurth@vmware.com> 2.8.2-8
- bump version as part of samba update
* Mon Jul 17 2023 Guruswamy Basavaiah <bguruswamy@vmware.com> 2.8.2-7
- Bump version as a part of bindutils upgrade
* Wed Jul 05 2023 Piyush Gupta <gpiyush@vmware.com> 2.8.2-6
- Replace Requires and BuildRequires from nfs-utils to libnfsidmap.
* Thu Jun 22 2023 Oliver Kurth <okurth@vmware.com> 2.8.2-5
- bump version as part of samba and libldb update
* Thu May 25 2023 Ashwin Dayanand Kamat <kashwindayan@vmware.com> 2.8.2-4
- Bump version as a part of libuv upgrade
* Wed Apr 12 2023 Ashwin Dayanand Kamat <kashwindayan@vmware.com> 2.8.2-3
- Bump version as a part of libevent upgrade
* Wed Mar 15 2023 Anmol Jain <anmolja@vmware.com> 2.8.2-2
