...
%define srcname setuptools_rust
...
Source0: https://files.pythonhosted.org/packages/source/s/setuptools-rust/%{srcname}-%{version}.tar.gz
...
rm -r examples/html-py-ever/tests
