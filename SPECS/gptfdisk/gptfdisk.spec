...
%define sha1 %{name}=406ab2596e1911c916dce677ce7e903076d94c6d

Patch0:     gptfdisk-%{version}-convenience-1.patch
Patch1:     gptfdisk-fix-compilation-%{version}.patch
Patch2:     gptfdisk-Makefile.patch
