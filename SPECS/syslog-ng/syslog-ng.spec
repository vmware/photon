...
%define sha1    %{name}=81bb726c9823a3af9701a4297311e71f68050ccb
...
rm %{buildroot}/%{_libdir}/pkgconfig/syslog-ng-test.pc \
    %{buildroot}/%{_libdir}/syslog-ng/libtest/libsyslog-ng-test.a \
    %{buildroot}/%{_libdir}/systemd/system/syslog-ng@.service
