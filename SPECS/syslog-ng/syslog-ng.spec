...
%{_includedir}/syslog-ng/compat/*.h
%{_includedir}/syslog-ng/control/*.h
%{_includedir}/syslog-ng/filter/*.h
%{_includedir}/syslog-ng/ivykis/*.h
%{_includedir}/syslog-ng/libtest/*.h
%{_includedir}/syslog-ng/logproto/*.h
%{_includedir}/syslog-ng/parser/*.h
%{_includedir}/syslog-ng/rewrite/*.h
%{_includedir}/syslog-ng/stats/*.h
%{_includedir}/syslog-ng/template/*.h
%{_includedir}/syslog-ng/transport/*.h
