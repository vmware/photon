...
%exclude %{_datadir}/%{name}/nexus-base-template-%{version}-01/bin/%{name}.bat
%exclude %{_datadir}/%{name}/nexus-base-template-%{version}-01/bin/setenv.bat

%changelog
*    Thu Sep 27 2018 Keerthana K <keerthanak@vmware.com> 3.13.0-1
