...
Vendor:         VMware, Inc.
Distribution:   Photon
Source:         http://mirrors.ocf.berkeley.edu/apache/zookeeper/zookeeper-3.4.10/%{name}-%{version}.tar.gz
...
%changelog
*   Mon Nov 06 2017 Xiaolin Li <xiaolinl@vmware.com> 3.4.10-1
-   Upgrade to 3.4.10 to address CVE-2017-5637
