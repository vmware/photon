...
%define sha512  %{name}=966bbfa93f06aa747a0c7af714681d4e2d09431b8bbf53d31dd106d8411d769d8b6162fe99cbdd322837e34a8f4ac371eb04638a4d17db1fb4ead9615d4eb071
...
install -vdm 755 %{buildroot}%{_datarootdir}/bash-completion/completions
install -m 0644 contrib/completion/git-completion.bash %{buildroot}%{_datarootdir}/bash-completion/completions/git
%find_lang %{name}
%{_fixperms} %{buildroot}/*
