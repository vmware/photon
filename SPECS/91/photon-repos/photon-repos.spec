...
%changelog
*   Mon Jun 01 2026 Bo Gan <bo.gan@broadcom.com> 5.0-10.2
-   Update the RSA 4096-bit GPG key with SHA256 signature, and deprecate 1024-bit key
-   Remove photon-updates repo in 91 to avoid confusion
-   Cleanup: Move to /91 and follow the subrelease versioning
