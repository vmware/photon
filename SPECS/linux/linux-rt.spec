...
# -esx
Patch0421:        serial-8250-do-not-probe-U6-16550A-fifo-size.patch
Patch0422:        01-clear-linux.patch
Patch0423:        02-pci-probe.patch
Patch0424:        03-poweroff.patch
Patch0425:        04-quiet-boot.patch
Patch0426:        05-pv-ops-clocksource.patch
Patch0427:        06-pv-ops-boot_clock.patch
Patch0428:        07-vmware-only.patch
Patch0429:        vmware-balloon-late-initcall.patch
Patch0430:        add-sysctl-to-disallow-unprivileged-CLONE_NEWUSER-by-default.patch
# Fix CVE-2017-1000252
Patch0431:        kvm-dont-accept-wrong-gsi-values.patch
# TODO: workaround for preempt-rt with ESX
Patch0432:	  0001-Don-t-enable-clocksource_vmware-at-the-beginning-of-.patch
...
%define uname_r %{version}-%{localversion_rt}-%{release}-rt

%description
The Preempt-RT Linux kernel build for GOS for VMware hypervisor.
