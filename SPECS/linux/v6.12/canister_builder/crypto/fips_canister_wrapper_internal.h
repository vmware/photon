...
extern int __init seqiv_module_init(void);
extern void __exit seqiv_module_exit(void);
extern int __init echainiv_module_init(void);
extern void __exit echainiv_module_exit(void);
extern int __init essiv_module_init(void);
extern void __exit essiv_module_exit(void);
