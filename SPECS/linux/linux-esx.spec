...
Patch203: 0003-x86-cpufeature-Remove-unused-and-seldomly-used-cpu_h.patch
Patch204: 0004-x86-cpu-Provide-a-config-option-to-disable-static_cp.patch
Patch205: 0005-x86-fpu-Add-an-XSTATE_OP-macro.patch
Patch206: 0006-x86-fpu-Get-rid-of-xstate_fault.patch
Patch207: 0007-x86-headers-Don-t-include-asm-processor.h-in-asm-ato.patch
Patch208: 0008-x86-cpufeature-Carve-out-X86_FEATURE_.patch
Patch209: 0009-x86-cpufeature-Replace-the-old-static_cpu_has-with-s.patch
Patch210: 0010-x86-cpufeature-Get-rid-of-the-non-asm-goto-variant.patch
Patch211: 0011-x86-alternatives-Add-an-auxilary-section.patch
Patch212: 0012-x86-alternatives-Discard-dynamic-check-after-init.patch
Patch213: 0013-x86-vdso-Use-static_cpu_has.patch
Patch214: 0014-x86-boot-Simplify-kernel-load-address-alignment-chec.patch
Patch215: 0015-x86-cpufeature-Speed-up-cpu_feature_enabled.patch
Patch216: 0016-x86-cpufeature-x86-mm-pkeys-Add-protection-keys-rela.patch
Patch217: 0017-x86-mm-pkeys-Fix-mismerge-of-protection-keys-CPUID-b.patch
Patch218: 0018-x86-cpu-Add-detection-of-AMD-RAS-Capabilities.patch
Patch219: 0019-x86-cpufeature-x86-mm-pkeys-Fix-broken-compile-time-.patch
Patch220: 0020-x86-cpufeature-Update-cpufeaure-macros.patch
Patch221: 0021-x86-cpufeature-Make-sure-DISABLED-REQUIRED-macros-ar.patch
Patch222: 0022-x86-cpufeature-Add-helper-macro-for-mask-check-macro.patch
Patch223: 0023-x86-cpu-Probe-CPUID-leaf-6-even-when-cpuid_level-6.patch
Patch224: 0024-x86-cpufeatures-Add-CPUID_7_EDX-CPUID-leaf.patch
Patch225: 0025-x86-cpufeatures-Add-Intel-feature-bits-for-Speculati.patch
Patch226: 0026-x86-cpufeatures-Add-AMD-feature-bits-for-Speculation.patch
Patch227: 0027-x86-msr-Add-definitions-for-new-speculation-control-.patch
Patch228: 0028-x86-pti-Do-not-enable-PTI-on-CPUs-which-are-not-vuln.patch
Patch229: 0029-x86-cpufeature-Blacklist-SPEC_CTRL-PRED_CMD-on-early.patch
Patch230: 0030-x86-speculation-Add-basic-IBPB-Indirect-Branch-Predi.patch
Patch231: 0031-x86-cpufeatures-Clean-up-Spectre-v2-related-CPUID-fl.patch
Patch232: 0032-x86-cpuid-Fix-up-virtual-IBRS-IBPB-STIBP-feature-bit.patch
Patch233: 0033-x86-pti-Mark-constant-arrays-as-__initconst.patch
Patch234: 0034-kvm-x86-nVMX-maintain-internal-copy-of-current-VMCS.patch
Patch235: 0035-KVM-VMX-Add-VMCS-to-CPU-s-loaded-VMCSs-before-VMPTRL.patch
Patch236: 0036-KVM-nVMX-fix-msr-bitmaps-to-prevent-L2-from-accessin.patch
Patch237: 0037-KVM-VMX-Enable-MSR-BASED-TPR-shadow-even-if-APICv-is.patch
Patch238: 0038-kvm-nVMX-VMCLEAR-an-active-shadow-VMCS-after-last-us.patch
Patch239: 0039-KVM-nVMX-mark-vmcs12-pages-dirty-on-L2-exit.patch
Patch240: 0040-KVM-nVMX-Eliminate-vmcs02-pool.patch
Patch241: 0041-KVM-VMX-introduce-alloc_loaded_vmcs.patch
Patch242: 0042-KVM-VMX-make-MSR-bitmaps-per-VCPU.patch
Patch243: 0043-KVM-x86-remove-magic-number-with-enum-cpuid_leafs.patch
Patch244: 0044-KVM-x86-Add-IBPB-support.patch
Patch245: 0045-KVM-VMX-Emulate-MSR_IA32_ARCH_CAPABILITIES.patch
Patch246: 0046-KVM-VMX-Allow-direct-access-to-MSR_IA32_SPEC_CTRL.patch
Patch247: 0047-KVM-SVM-Allow-direct-access-to-MSR_IA32_SPEC_CTRL.patch
Patch248: 0048-x86-asm-entry-32-Simplify-pushes-of-zeroed-pt_regs-R.patch
Patch249: 0049-x86-entry-64-compat-Clear-registers-for-compat-sysca.patch
Patch250: 0050-x86-speculation-Update-Speculation-Control-microcode.patch
Patch251: 0051-x86-speculation-Correct-Speculation-Control-microcod.patch
Patch252: 0052-X86-nVMX-Properly-set-spec_ctrl-and-pred_cmd-before-.patch
Patch253: 0053-x86-speculation-Clean-up-various-Spectre-related-det.patch
Patch254: 0054-x86-speculation-Fix-up-array_index_nospec_mask-asm-c.patch
Patch255: 0055-x86-speculation-Add-asm-msr-index.h-dependency.patch
Patch256: 0056-x86-xen-Zero-MSR_IA32_SPEC_CTRL-before-suspend.patch
Patch257: 0057-KVM-x86-Remove-indirect-MSR-op-calls-from-SPEC_CTRL.patch
Patch258: 0058-KVM-VMX-Optimize-vmx_vcpu_run-and-svm_vcpu_run-by-ma.patch
Patch259: 0059-x86-mm-Factor-out-LDT-init-from-context-init.patch
Patch260: 0060-x86-mm-Give-each-mm-TLB-flush-generation-a-unique-ID.patch
Patch261: 0061-x86-speculation-Use-Indirect-Branch-Prediction-Barri.patch
Patch262: 0062-x86-spectre_v2-Don-t-check-microcode-versions-when-r.patch
Patch263: 0063-x86-speculation-Use-IBRS-if-available-before-calling.patch
Patch264: 0064-x86-speculation-Move-firmware_restrict_branch_specul.patch
Patch265: 0065-x86-speculation-Remove-Skylake-C2-from-Speculation-C.patch
Patch266: 0066-selftest-seccomp-Fix-the-flag-name-SECCOMP_FILTER_FL.patch
Patch267: 0067-selftest-seccomp-Fix-the-seccomp-2-signature.patch

# Fix CVE-2018-3639 (Speculative Store Bypass)
Patch268: 0068-x86-amd-don-t-set-X86_BUG_SYSRET_SS_ATTRS-when-runni.patch
Patch269: 0069-x86-nospec-Simplify-alternative_msr_write.patch
Patch270: 0070-x86-bugs-Concentrate-bug-detection-into-a-separate-f.patch
Patch271: 0071-x86-bugs-Concentrate-bug-reporting-into-a-separate-f.patch
Patch272: 0072-x86-bugs-Read-SPEC_CTRL-MSR-during-boot-and-re-use-r.patch
Patch273: 0073-x86-bugs-KVM-Support-the-combination-of-guest-and-ho.patch
Patch274: 0074-x86-bugs-Expose-sys-.-spec_store_bypass.patch
Patch275: 0075-x86-cpufeatures-Add-X86_FEATURE_RDS.patch
Patch276: 0076-x86-bugs-Provide-boot-parameters-for-the-spec_store_.patch
Patch277: 0077-x86-bugs-intel-Set-proper-CPU-features-and-setup-RDS.patch
Patch278: 0078-x86-bugs-Whitelist-allowed-SPEC_CTRL-MSR-values.patch
Patch279: 0079-x86-bugs-AMD-Add-support-to-disable-RDS-on-Fam-15-16.patch
Patch280: 0080-x86-KVM-VMX-Expose-SPEC_CTRL-Bit-2-to-the-guest.patch
Patch281: 0081-x86-speculation-Create-spec-ctrl.h-to-avoid-include-.patch
Patch282: 0082-prctl-Add-speculation-control-prctls.patch
Patch283: 0083-x86-process-Optimize-TIF-checks-in-__switch_to_xtra.patch
Patch284: 0084-x86-process-Correct-and-optimize-TIF_BLOCKSTEP-switc.patch
Patch285: 0085-x86-process-Optimize-TIF_NOTSC-switch.patch
Patch286: 0086-x86-process-Allow-runtime-control-of-Speculative-Sto.patch
Patch287: 0087-x86-speculation-Add-prctl-for-Speculative-Store-Bypa.patch
Patch288: 0088-nospec-Allow-getting-setting-on-non-current-task.patch
Patch289: 0089-proc-Provide-details-on-speculation-flaw-mitigations.patch
Patch290: 0090-seccomp-Enable-speculation-flaw-mitigations.patch
Patch291: 0091-x86-bugs-Make-boot-modes-__ro_after_init.patch
Patch292: 0092-prctl-Add-force-disable-speculation.patch
Patch293: 0093-seccomp-Use-PR_SPEC_FORCE_DISABLE.patch
Patch294: 0094-seccomp-Add-filter-flag-to-opt-out-of-SSB-mitigation.patch
Patch295: 0095-seccomp-Move-speculation-migitation-control-to-arch-.patch
Patch296: 0096-x86-speculation-Make-seccomp-the-default-mode-for-Sp.patch
Patch297: 0097-x86-bugs-Rename-_RDS-to-_SSBD.patch
Patch298: 0098-proc-Use-underscores-for-SSBD-in-status.patch
Patch299: 0099-Documentation-spec_ctrl-Do-some-minor-cleanups.patch
Patch300: 0100-x86-bugs-Fix-__ssb_select_mitigation-return-type.patch
Patch301: 0101-x86-bugs-Make-cpu_show_common-static.patch
Patch302: 0102-x86-bugs-Fix-the-parameters-alignment-and-missing-vo.patch
Patch303: 0103-x86-cpu-Make-alternative_msr_write-work-for-32-bit-c.patch
Patch304: 0104-KVM-SVM-Move-spec-control-call-after-restore-of-GS.patch
Patch305: 0105-x86-speculation-Use-synthetic-bits-for-IBRS-IBPB-STI.patch
Patch306: 0106-x86-cpufeatures-Disentangle-MSR_SPEC_CTRL-enumeratio.patch
Patch307: 0107-x86-cpufeatures-Disentangle-SSBD-enumeration.patch
Patch308: 0108-x86-cpu-AMD-Fix-erratum-1076-CPB-bit.patch
Patch309: 0109-x86-cpufeatures-Add-FEATURE_ZEN.patch
Patch310: 0110-x86-speculation-Handle-HT-correctly-on-AMD.patch
Patch311: 0111-x86-bugs-KVM-Extend-speculation-control-for-VIRT_SPE.patch
Patch312: 0112-x86-speculation-Add-virtualized-speculative-store-by.patch
Patch313: 0113-x86-speculation-Rework-speculative_store_bypass_upda.patch
Patch314: 0114-x86-bugs-Unify-x86_spec_ctrl_-set_guest-restore_host.patch
Patch315: 0115-x86-bugs-Expose-x86_spec_ctrl_base-directly.patch
Patch316: 0116-x86-bugs-Remove-x86_spec_ctrl_set.patch
Patch317: 0117-x86-bugs-Rework-spec_ctrl-base-and-mask-logic.patch
Patch318: 0118-x86-speculation-KVM-Implement-support-for-VIRT_SPEC_.patch
Patch319: 0119-KVM-SVM-Implement-VIRT_SPEC_CTRL-support-for-SSBD.patch
Patch320: 0120-x86-bugs-Rename-SSBD_NO-to-SSB_NO.patch
