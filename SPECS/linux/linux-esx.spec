...
Patch238: 0038-KVM-VMX-Enable-MSR-BASED-TPR-shadow-even-if-APICv-is.patch
Patch239: 0039-kvm-nVMX-VMCLEAR-an-active-shadow-VMCS-after-last-us.patch
Patch240: 0040-KVM-nVMX-mark-vmcs12-pages-dirty-on-L2-exit.patch
Patch241: 0041-KVM-nVMX-Eliminate-vmcs02-pool.patch
Patch242: 0042-KVM-VMX-introduce-alloc_loaded_vmcs.patch
Patch243: 0043-KVM-VMX-make-MSR-bitmaps-per-VCPU.patch
Patch244: 0044-KVM-x86-remove-magic-number-with-enum-cpuid_leafs.patch
Patch245: 0045-KVM-x86-Add-IBPB-support.patch
Patch246: 0046-KVM-VMX-Emulate-MSR_IA32_ARCH_CAPABILITIES.patch
Patch247: 0047-KVM-VMX-Allow-direct-access-to-MSR_IA32_SPEC_CTRL.patch
Patch248: 0048-KVM-SVM-Allow-direct-access-to-MSR_IA32_SPEC_CTRL.patch
Patch249: 0049-x86-asm-entry-32-Simplify-pushes-of-zeroed-pt_regs-R.patch
Patch250: 0050-x86-entry-64-compat-Clear-registers-for-compat-sysca.patch
Patch251: 0051-x86-speculation-Update-Speculation-Control-microcode.patch
Patch252: 0052-x86-speculation-Correct-Speculation-Control-microcod.patch
Patch253: 0053-X86-nVMX-Properly-set-spec_ctrl-and-pred_cmd-before-.patch
Patch254: 0054-x86-speculation-Clean-up-various-Spectre-related-det.patch
Patch255: 0055-x86-speculation-Fix-up-array_index_nospec_mask-asm-c.patch
Patch256: 0056-x86-speculation-Add-asm-msr-index.h-dependency.patch
Patch257: 0057-x86-xen-Zero-MSR_IA32_SPEC_CTRL-before-suspend.patch
Patch258: 0058-KVM-x86-Remove-indirect-MSR-op-calls-from-SPEC_CTRL.patch
Patch259: 0059-KVM-VMX-Optimize-vmx_vcpu_run-and-svm_vcpu_run-by-ma.patch
Patch260: 0060-x86-mm-Factor-out-LDT-init-from-context-init.patch
Patch261: 0061-x86-mm-Give-each-mm-TLB-flush-generation-a-unique-ID.patch
Patch262: 0062-x86-speculation-Use-Indirect-Branch-Prediction-Barri.patch
Patch263: 0063-x86-spectre_v2-Don-t-check-microcode-versions-when-r.patch
Patch264: 0064-x86-speculation-Use-IBRS-if-available-before-calling.patch
Patch265: 0065-x86-speculation-Move-firmware_restrict_branch_specul.patch
Patch266: 0066-x86-speculation-Remove-Skylake-C2-from-Speculation-C.patch
Patch267: 0067-selftest-seccomp-Fix-the-flag-name-SECCOMP_FILTER_FL.patch
Patch268: 0068-selftest-seccomp-Fix-the-seccomp-2-signature.patch

# Fix CVE-2018-3639 (Speculative Store Bypass)
Patch269: 0069-x86-amd-don-t-set-X86_BUG_SYSRET_SS_ATTRS-when-runni.patch
Patch270: 0070-x86-nospec-Simplify-alternative_msr_write.patch
Patch271: 0071-x86-bugs-Concentrate-bug-detection-into-a-separate-f.patch
Patch272: 0072-x86-bugs-Concentrate-bug-reporting-into-a-separate-f.patch
Patch273: 0073-x86-bugs-Read-SPEC_CTRL-MSR-during-boot-and-re-use-r.patch
Patch274: 0074-x86-bugs-KVM-Support-the-combination-of-guest-and-ho.patch
Patch275: 0075-x86-bugs-Expose-sys-.-spec_store_bypass.patch
Patch276: 0076-x86-cpufeatures-Add-X86_FEATURE_RDS.patch
Patch277: 0077-x86-bugs-Provide-boot-parameters-for-the-spec_store_.patch
Patch278: 0078-x86-bugs-intel-Set-proper-CPU-features-and-setup-RDS.patch
Patch279: 0079-x86-bugs-Whitelist-allowed-SPEC_CTRL-MSR-values.patch
Patch280: 0080-x86-bugs-AMD-Add-support-to-disable-RDS-on-Fam-15-16.patch
Patch281: 0081-x86-KVM-VMX-Expose-SPEC_CTRL-Bit-2-to-the-guest.patch
Patch282: 0082-x86-speculation-Create-spec-ctrl.h-to-avoid-include-.patch
Patch283: 0083-prctl-Add-speculation-control-prctls.patch
Patch284: 0084-x86-process-Optimize-TIF-checks-in-__switch_to_xtra.patch
Patch285: 0085-x86-process-Correct-and-optimize-TIF_BLOCKSTEP-switc.patch
Patch286: 0086-x86-process-Optimize-TIF_NOTSC-switch.patch
Patch287: 0087-x86-process-Allow-runtime-control-of-Speculative-Sto.patch
Patch288: 0088-x86-speculation-Add-prctl-for-Speculative-Store-Bypa.patch
Patch289: 0089-nospec-Allow-getting-setting-on-non-current-task.patch
Patch290: 0090-proc-Provide-details-on-speculation-flaw-mitigations.patch
Patch291: 0091-seccomp-Enable-speculation-flaw-mitigations.patch
Patch292: 0092-x86-bugs-Make-boot-modes-__ro_after_init.patch
Patch293: 0093-prctl-Add-force-disable-speculation.patch
Patch294: 0094-seccomp-Use-PR_SPEC_FORCE_DISABLE.patch
Patch295: 0095-seccomp-Add-filter-flag-to-opt-out-of-SSB-mitigation.patch
Patch296: 0096-seccomp-Move-speculation-migitation-control-to-arch-.patch
Patch297: 0097-x86-speculation-Make-seccomp-the-default-mode-for-Sp.patch
Patch298: 0098-x86-bugs-Rename-_RDS-to-_SSBD.patch
Patch299: 0099-proc-Use-underscores-for-SSBD-in-status.patch
Patch300: 0100-Documentation-spec_ctrl-Do-some-minor-cleanups.patch
Patch301: 0101-x86-bugs-Fix-__ssb_select_mitigation-return-type.patch
Patch302: 0102-x86-bugs-Make-cpu_show_common-static.patch
Patch303: 0103-x86-bugs-Fix-the-parameters-alignment-and-missing-vo.patch
Patch304: 0104-x86-cpu-Make-alternative_msr_write-work-for-32-bit-c.patch
Patch305: 0105-KVM-SVM-Move-spec-control-call-after-restore-of-GS.patch
Patch306: 0106-x86-speculation-Use-synthetic-bits-for-IBRS-IBPB-STI.patch
Patch307: 0107-x86-cpufeatures-Disentangle-MSR_SPEC_CTRL-enumeratio.patch
Patch308: 0108-x86-cpufeatures-Disentangle-SSBD-enumeration.patch
Patch309: 0109-x86-cpu-AMD-Fix-erratum-1076-CPB-bit.patch
Patch310: 0110-x86-cpufeatures-Add-FEATURE_ZEN.patch
Patch311: 0111-x86-speculation-Handle-HT-correctly-on-AMD.patch
Patch312: 0112-x86-bugs-KVM-Extend-speculation-control-for-VIRT_SPE.patch
Patch313: 0113-x86-speculation-Add-virtualized-speculative-store-by.patch
Patch314: 0114-x86-speculation-Rework-speculative_store_bypass_upda.patch
Patch315: 0115-x86-bugs-Unify-x86_spec_ctrl_-set_guest-restore_host.patch
Patch316: 0116-x86-bugs-Expose-x86_spec_ctrl_base-directly.patch
Patch317: 0117-x86-bugs-Remove-x86_spec_ctrl_set.patch
Patch318: 0118-x86-bugs-Rework-spec_ctrl-base-and-mask-logic.patch
Patch319: 0119-x86-speculation-KVM-Implement-support-for-VIRT_SPEC_.patch
Patch320: 0120-KVM-SVM-Implement-VIRT_SPEC_CTRL-support-for-SSBD.patch
Patch321: 0121-x86-bugs-Rename-SSBD_NO-to-SSB_NO.patch
