...
Patch12: 0001-fork-add-sysctl-to-disallow-unprivileged-CLONE_NEWUS.patch
# Out-of-tree patches from AppArmor:
Patch13: 0001-apparmor-patch-to-provide-compatibility-with-v2.x-ne.patch
Patch14: 0002-apparmor-af_unix-mediation.patch
...
# synchronization.
Patch23: vfio-Only-set-INTX_DISABLE-bit-during-disable.patch
...
* Mon Jan 08 2024 Roye Eshed <roye.eshed@broadcom.com> 6.1.62-9
