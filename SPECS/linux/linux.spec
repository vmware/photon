...
photon_cmdline=net.ifnames=0 init=/lib/systemd/systemd ro loglevel=3 quiet plymouth.enable=0 coredump_filter=0x37
...
%changelog
*   Sun Apr 10 2016 Anish Swaminathan <anishs@vmware.com> 4.2.0-25
-   Set coredump_filter to 0x37
