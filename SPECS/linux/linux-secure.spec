...
photon_cmdline=init=/lib/systemd/systemd ro loglevel=3 quiet no-vmw-sta loadpin.enabled=0 slub_debug=P page_poison=1 slab_nomerge spec_store_bypass_disable=seccomp
...
%changelog
*   Mon Jun 11 2018 Srivatsa S. Bhat <srivatsa@csail.mit.edu> 4.9.101-2
-   Use 'seccomp' as the Speculative Store Bypass mitigation method.
