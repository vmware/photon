...
# Fix CVE-2023-52531
Patch208: 0001-wifi-iwlwifi-mvm-Fix-a-memory-corruption-issue.patch
...
# Fix CVE-2024-42321
Patch231:  0001-net-flow_dissector-use-DEBUG_NET_WARN_ON_ONCE.patch
...
# Fix CVE-2023-53597
Patch248: 0001-cifs-fix-mid-leak-during-reconnection-after-timeout-.patch

# Fix CVE-2025-39990
Patch249: 0001-bpf-Check-the-helper-function-is-valid-in-get_helper.patch

# Fix CVE-2022-49635
Patch250: 0001-drm-i915-selftests-fix-subtraction-overflow-bug.patch

# Fix CVE-2025-40099
Patch251: 0001-cifs-parse_dfs_referrals-prevent-oob-on-malformed-in.patch
# Fix CVE-2022-50406
Patch252: 0001-iomap-iomap-fix-memory-corruption-when-recording-err.patch
# Fix CVE-2025-39838
Patch253: 0001-cifs-prevent-NULL-pointer-dereference-in-UTF16-conve.patch
# Fix CVE-2025-38068
Patch254: 0001-lib-lzo-lzo1x_compress.c-make-lzogeneric1x_1_compres.patch
Patch255: 0002-lib-lzo-lzo1x_compress.c-replace-ternary-operator-wi.patch
Patch256: 0003-crypto-lzo-Fix-compression-buffer-overrun.patch

# Fix CVE-2025-22121
Patch257: 0001-ext4-introduce-ITAIL-helper.patch
Patch258: 0001-ext4-fix-out-of-bound-read-in-ext4_xattr_inode_dec_r.patch

# Fix CVE-2025-22022
Patch259: 0001-usb-xhci-move-link-chain-bit-quirk-checks-into-one-h.patch
Patch260: 0001-usb-xhci-Apply-the-link-chain-quirk-on-NEC-isoc-endp.patch

# Fix CVE-2024-35939
Patch262: 0001-dma-direct-Leak-pages-on-dma_set_decrypted-failure.patch
# Fix CVE-2023-53401
Patch263: 0001-mm-kmem-fix-a-NULL-pointer-dereference-in-obj_stock_.patch
Patch264: 0002-mm-memcg-use-READ_ONCE-WRITE_ONCE-to-access-stock-ca.patch
# Fix CVE-2022-49935
Patch265: 0001-dma-buf-dma-resv-check-if-the-new-fence-is-really-la.patch
Patch266: 0002-dma-buf-fix-check-in-dma_resv_add_fence.patch

# Fix CVE-2022-49961
Patch267:   0001-bpf-Do-mark_chain_precision-for-ARG_CONST_ALLOC_SIZE.patch

# Fix CVE-2025-40110
Patch268:   0001-drm-vmwgfx-Fix-a-null-ptr-access-in-the-cursor-snoop.patch

# Fix CVE-2025-38022
Patch269:   0001-RDMA-core-Fix-KASAN-slab-use-after-free-Read-in-ib_r.patch

# Fix CVE-2025-38119
Patch270:   0001-scsi-core-ufs-Fix-a-hang-in-the-error-handler.patch

# Fix CVE-2025-37830
Patch271:   0001-cpufreq-scmi-Fix-null-ptr-deref-in-scmi_cpufreq_get_.patch
...
# Fix CVE-2025-39797
Patch281: 0001-xfrm-Duplicate-SPI-Handling.patch
Patch282: 0001-xfrm-xfrm_alloc_spi-shouldn-t-use-0-as-SPI.patch

# CVE-2022-48744
Patch283: 0001-net-mlx5e-Avoid-field-overflowing-memcpy.patch

# CVE-2025-39810
Patch284: 0001-bnxt_en-Fix-possible-crash-after-creating-sw-mqprio-.patch
Patch285: 0002-bnxt_en-Fix-memory-corruption-when-FW-resources-chan.patch

# CVE-2023-53282
Patch286: 0001-scsi-lpfc-Fix-use-after-free-KFENCE-violation-during.patch

# CVE-2025-38129
Patch287: 0001-page_pool-fix-inconsistency-for-page_pool_ring_-un-l.patch
Patch288: 0002-page_pool-Fix-use-after-free-in-page_pool_recycle_in.patch
# CVE-2025-38584
...
# CVE-2023-53111
Patch296: 0001-loop-Fix-use-after-free-issues.patch
# CVE-2025-68379
Patch297: 0001-RDMA-rxe-Fix-null-deref-on-srq-rq.queue-after-resize.patch
# CVE-2025-68372
...
Patch1600:       0001-Fonts-Add-charcount-field-to-font_desc.patch
Patch1601:       0002-console-Delete-unused-con_font_copy-callback-impleme.patch
Patch1602:       0003-fbcon-Avoid-using-FNTCHARCNT-and-hard-coded-built-in.patch
