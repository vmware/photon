...
Patch1:         krb5-1.14-bindresvport-blacklist.patch
Requires:	openssl
Requires:	e2fsprogs
...
%changelog
* 	Fri Mar 18 2016 Anish Swaminathan <anishs@vmware.com>  1.14-3
- 	Add patch for accepting bindresvport.blacklist file
