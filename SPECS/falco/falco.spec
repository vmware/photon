...
sed -i 's|/var/lib/dkms/$PACKAGE_NAME/$SYSDIG_VERSION/$KERNEL_RELEASE/$ARCH/module/$PROBE_NAME.ko|/lib/modules/%{KERNEL_VERSION}-%{KERNEL_RELEASE}/extra/$PROBE_NAME.ko|g' %{buildroot}/usr/bin/falco-probe-loader
