...
%description
The Inetutils pasckage contains programs for basic networking.

%package telnet
Summary: A telnet client.
Group: Applications/Internet
Requires: glibc >= 2.22
%description telnet
Telnet is an application layer protocol used on the Internet or local area networks to provide a bidirectional interactive text-oriented communication facility using a virtual terminal connection. This package provides a command line telnet client.
%prep
%setup -q
...
%changelog
*   Wed Sep 28 2016 Xiaolin Li <xiaolinl@vmware.com> 1.9.2-4
-   Add a inetutils-telnet subpackage.
