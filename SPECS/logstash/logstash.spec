...
%define sha1 %{name}-%{version}.tar.gz=46e540403e6b3158dd21cc23cae8f2bc3ba38f0a
Patch0:         apostrophe.patch
...
install -vdm 750 %{buildroot}%{_datadir}/%{name}/x-pack
...
cp -r x-pack %{buildroot}%{_datadir}/%{name}/x-pack
...
%changelog
*   Wed Jul 18 2018 Ankit Jain <ankitja@vmware.com> 6.3.0-1
-   Initial Version.
