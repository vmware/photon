...
mkdir -p %{buildroot}%{_libdir}/ktap
cp  ktap %{buildroot}%{_bindir}/ktap
cp  ktapvm.ko %{buildroot}%{_libdir}/ktap/ktapvm.ko

%post
/sbin/insmod /usr/lib/ktap/ktapvm.ko
