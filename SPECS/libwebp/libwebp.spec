...
%changelog
* Mon Jun 20 2022 Shivani Agarwal <shivania2@vmware.com>  1.0.3-3
- Version bump up to use libtiff 4.4.0
* Mon Mar 21 2022 Harinadh D <hdommaraju@vmware.com> 1.0.3-2
- Bump version to build with libtiff 4.3.0
