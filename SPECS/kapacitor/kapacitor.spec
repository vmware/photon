...
cp -r %{name}-%{version}/* build/src/github.com/influxdata/kapacitor
cd build
export GOPATH=`pwd`
...
cp -r ../build/src/github.com/influxdata/kapacitor/kapacitor %{buildroot}%{_bindir}
cp -r ../build/src/github.com/influxdata/kapacitor/kapacitord %{buildroot}%{_bindir}
cp -r ../build/src/github.com/influxdata/kapacitor/tickfmt %{buildroot}%{_bindir}
...
%{_sysconfdir}/logrotate.d/kapacitor
%{_sysconfdir}/kapacitor/kapacitor.conf
