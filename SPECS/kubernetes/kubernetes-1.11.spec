...
Release:        1%{?dist}
License:        ASL 2.0
URL:            https://github.com/kubernetes/kubernetes/archive/v%{version}-beta.2.tar.gz
Source0:        https://github.com/kubernetes/kubernetes/archive/v%{version}-beta.2.tar.gz
%define sha1    v%{version}-beta.2.tar.gz=93c9eb404aefad716d2d3626ec87b69a6a673b5d
...
%changelog
*   Fri Jun 08 2018 Tapas Kundu <tkundu@vmware.com> 1.11.0-beta.2-1
-   Beta version 2 Kubernates 1.11
