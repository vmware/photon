...
CGO_ENABLED=0 go build -v -i -o dist/kube-controllers cmd/kube-controllers/main.go
CGO_ENABLED=0 go build -v -i -o dist/check-status cmd/check-status/main.go
popd
