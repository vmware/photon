...
%define sha1    %{name}=6b8c215c7e7bfb2061cff8769be2a54f032919ec

Patch0: add-debug-symbols-to-build.patch
Patch1: remove-tls-1.3-related-code.patch
...
%post
if [ $1 -ge 1 ]; then
  install -v -d -m 0755 %{_datadir}/%{name}/empty
...
%changelog
* Wed Apr 06 2022 Shreenidhi Shedi <sshedi@vmware.com> 3.0.4-1
- Upgrade to v 3.0.4
