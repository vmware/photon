...
%defattr(-,root,root)
%{_libdir}/libpytalloc-util.cpython-314*linux-gnu.so.*
...
%changelog
* Wed Jun 03 2026 Harinadh Dommaraju <Harinadh.Dommaraju@broadcom.com> 2.4.4-3
- Release version bump as part of libxml2/libxslt
* Fri May 15 2026 Vamsi Krishna Brahmajosyula <vamsi-krishna.brahmajosyula@broadcom.com> 2.4.4-2
...
* Fri Apr 11 2025 Michelle Wang <michelle.wang@broadcom.com> 2.4.1-1
- Bump up version to 2.4.1 required by samba-client 4.19.3
* Wed Dec 11 2024 Mukul Sikka <mukul.sikka@broadcom.com> 2.4.0-2
