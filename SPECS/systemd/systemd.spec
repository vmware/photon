...
#From https://github.com/systemd/systemd/pull/6020
Patch7:           systemd-233-CVE-2017-9217-fix.patch		 
Requires:         Linux-PAM
Requires:         libcap
Requires:         xz
Requires:         kmod
...
%changelog
*    Thu Jun 29 2017 Harish Udaiya Kumar <hudaiyakumar@vmware.com> 233-2
-    Add fix for CVE-2017-9217
