...
#mkdir -p %{buildroot}%{_datadir}/doc/%{name}/arm
#mkdir -p %{buildroot}%{_datadir}/doc/%{name}/misc
mkdir -p %{buildroot}/usr/bin
mkdir -p %{buildroot}/usr/sbin
mkdir -p %{buildroot}/usr/lib/sysusers.d/
mkdir -p %{buildroot}/usr/lib/tmpfiles.d/
mkdir -p %{buildroot}%{_datadir}/licenses/bind/
...
cp LICENSE %{buildroot}%{_datadir}/licenses/bind/
cp COPYRIGHT %{buildroot}%{_datadir}/licenses/bind/
...
cp /usr/share/man/man1/host.1 %{buildroot}%{_datadir}/man/man1/
cp /usr/share/man/man1/dig.1 %{buildroot}%{_datadir}/man/man1/
cp /usr/share/man/man1/nslookup.1 %{buildroot}%{_datadir}/man/man1/
cp /usr/share/man/man1/delv.1 %{buildroot}%{_datadir}/man/man1/
cp /usr/share/man/man1/named-rrchecker.1 %{buildroot}%{_datadir}/man/man1/
cp /usr/share/man/man1/arpaname.1 %{buildroot}%{_datadir}/man/man1/
cp /usr/share/man/man1/mdig.1 %{buildroot}%{_datadir}/man/man1/
cp /usr/share/man/man1/nsupdate.1 %{buildroot}%{_datadir}/man/man1/
cp /usr/share/man/man1/isc-config.sh.1 %{buildroot}%{_datadir}/man/man1/
cp /usr/share/man/man1/bind9-config.1 %{buildroot}%{_datadir}/man/man1/

cp /usr/share/man/man5/named.conf.5 %{buildroot}%{_datadir}/man/man5/
cp /usr/share/man/man5/rndc.conf.5 %{buildroot}%{_datadir}/man/man5/

cp /usr/share/man/man8/named.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/rndc.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/dnssec-dsfromkey.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/dnssec-cds.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/dnssec-keyfromlabel.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/dnssec-importkey.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/dnssec-settime.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/dnssec-revoke.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/dnssec-keygen.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/dnssec-verify.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/dnssec-signzone.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/named-journalprint.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/nsec3hash.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/named-checkconf.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/named-checkzone.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/named-compilezone.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/rndc-confgen.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/ddns-confgen.8 %{buildroot}%{_datadir}/man/man8/
cp /usr/share/man/man8/tsig-keygen.8 %{buildroot}%{_datadir}/man/man8/

cp -R /usr/share/doc/%{name}-%{version}/* %{buildroot}%{_datadir}/doc/%{name}/
...
#sed '/conf/d;/^#/!d;s:^# ::' %{buildroot}/srv/named/etc/rndc.conf > %{buildroot}/srv/named/etc/named.conf
