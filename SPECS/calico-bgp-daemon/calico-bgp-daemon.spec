...
mkdir -p /root/.glide
cd ..
mv "${GOPATH}" calico-bgp-daemon
mkdir -p "${GOPATH}/src/github.com/projectcalico"
mv calico-bgp-daemon "${GOPATH}/src/github.com/projectcalico/"
...
install src/github.com/projectcalico/calico-bgp-daemon/dist/calico-bgp-daemon %{buildroot}%{_bindir}/
...
%changelog
*    Wed Oct 11 2017 Bo Gan <ganb@vmware.com> 0.2.2-3
-    cleanup GOPATH
