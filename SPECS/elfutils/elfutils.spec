...
- Removed Dwarf_Func type and functions; dwarf_func_name, dwarf_func_lowpc,
- dwarf_func_highpc, dwarf_func_entrypc, dwarf_func_die; dwarf_getfuncs
- callback now uses Dwarf_Die, and dwarf_func_file, dwarf_func_line, dwarf_func_col
- replaced by dwarf_decl_file, dwarf_decl_line, dwarf_decl_column; dwarf_func_inline,
- dwarf_func_inline_instances now take Dwarf_Die. Type Dwarf_Loc renamed to Dwarf_Op;
- dwarf_getloclist, dwarf_addrloclists renamed dwarf_getlocation, dwarf_getlocation_addr.
...
- DSO versions also for symbols in nobits sections.  Allow .rodata
- section to have STRINGS and MERGE flag set.
...
- against DSO versions also for symbols in nobits sections.  Allow .rodata
- section to have STRINGS and MERGE flag set.
* Sat Aug  6 2005 Ulrich Drepper <@redhat.com> 0.113-1
- elflint: relax a bit. Allow version definitions for defined symbols
