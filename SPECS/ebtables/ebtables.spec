...
cp %{SOURCE1} %{buildroot}/etc/systemd/scripts/ebtables
chmod 755 %{buildroot}/etc/systemd/scripts/ebtables

cat << EOF >> %{buildroot}/%{_libdir}/systemd/system/ebtables.service
[Unit]
