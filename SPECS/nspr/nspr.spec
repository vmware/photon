...
%package devel
Summary:        Development headers for nspr
Requires:       %{name} = %{version}-%{release}

%description devel
The nspr-devel package contains libraries, header files and documentation
for developing applications that use nspr.
...
%changelog
*   Mon Jan 30 2017 Xiaolin Li <xiaolinl@vmware.com> 4.12-3
