...
install -D -m755 COPYING %{buildroot}/%{_datadir}/licenses/COPYING
install -D -m755 AUTHORS %{buildroot}/%{_datadir}/licenses/AUTHORS
install -D -m755 NEWS %{buildroot}/%{_datadir}/licenses/NEWS
