...
URL:            http://cython.org/
Source0:        http://cython.org/release/Cython-src-%{version}.tar.gz
%define sha1 Cython-src=d3e9c49cb1fef58e7ddbfec8ac8c388bae554333
Vendor:         VMware, Inc.
Distribution:   Photon
...
%changelog
*   Sat Sep 15 2018 Tapas Kundu <tkundu@vmware.com> 0.28.5-1
-   Updated to 0.28.5 release.
