...
%define sha1 %{name}=13cbeb905bcc4add622c5a197c998fd79fb99587
...
%build
make CPPFLAGS="-I $PWD/../aufs4-standalone-aufs4.14/include/uapi" DESTDIR=%{buildroot} %{?_smp_mflags}

%install
make CPPFLAGS="-I $PWD/../aufs4-standalone-aufs4.14/include/uapi" DESTDIR=%{buildroot} install %{?_smp_mflags}
...
%changelog
* Sat Mar 26 2022 Shreenidhi Shedi <sshedi@vmware.com> 4.14-3
