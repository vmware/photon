...
%define sha1 lightwave=32c7618eaa89c61ac671a6d662fbbcb1798313fb
Distribution:  Photon
Requires:  coreutils >= 8.22, openssl >= 1.0.2, krb5 >= 1.14, cyrus-sasl >= 2.1, likewise-open >= 6.2.11, vmware-directory-client = %{version}, vmware-afd-client = %{version}, boost = 1.60.0
