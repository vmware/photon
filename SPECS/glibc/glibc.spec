...
# disable these patches temporarily to try
#Patch2:         0001-Do-not-use-__builtin_types_compatible_p-in-C++-mode.patch
#Patch3:         0002-Provide-a-C++-version-of-issignaling-that-does-not-use-__MATH_TG.patch
#Patch4:         0003-Do-not-use-generic-selection-in-C++-mode.patch
