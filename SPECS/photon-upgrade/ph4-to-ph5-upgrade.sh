...
declare -A replaced_pkgs_map=(
  ...
  [openjdk11-jre]="openjdk11-jre openjdk17-jre openjdk11 openjdk17"
  [pgaudit13]="pgaudit13 pgaudit16 pgaudit15 pgaudit14"
  [pgaudit14]="pgaudit14 pgaudit16 pgaudit15"
  [pmd]=pmd-ng
  [postgresql10]="postgresql16 postgresql15 postgresql14 postgresql13"
  [postgresql10-libs]="postgresql16-libs postgresql15-libs postgresql14-libs postgresql13-libs"
  [postgresql10-devel]="postgresql16-devel postgresql15-devel postgresql14-devel postgresql13-devel"
  ...
  [postgresql14]="postgresql14 postgresql16 postgresql15"
  [postgresql14-libs]="postgresql14-libs postgresql16-libs postgresql15-libs"
  [postgresql14-devel]="postgresql14-devel postgresql16-devel postgresql15-devel"
  [repmgr]="repmgr16 repmgr15 repmgr14 repmgr13"
  [repmgr10]="repmgr16 repmgr15 repmgr14 repmgr13"
  [repmgr13]="repmgr13 repmgr16 repmgr15 repmgr14"
  [repmgr14]="repmgr14 repmgr16 repmgr15"
)
