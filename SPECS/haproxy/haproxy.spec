...
Vendor:         VMware, Inc.
Distribution:   Photon
Source0:        http://www.haproxy.org/download/%{majorversion}/src/%{name}-%{version}.tar.gz
%define sha1 haproxy=5e100b88a3f30935609d9d8bf3813568f2b74358
Patch0:         haproxy-CVE-2018-11469.patch
...
%changelog
*   Mon Jul 09 2018 Dweep Advani <dadvani@vmware.com> 1.8.9-1
-   Upgrade to version 1.8.9 and fixing CVE-2018-11469
