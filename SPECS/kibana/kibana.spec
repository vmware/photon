...
%define sha1     kibana_build-%{version}p1=b6f0d476e3e7d0f3eb0d2b9fd5809d0c62e9dd5b
Patch0:          0001-Upgrade-node-version-to-10.24.0.patch
BuildArch:       x86_64
BuildRequires:   git
BuildRequires:   yarn
BuildRequires:   nodejs = 10.24.0
BuildRequires:   zip
