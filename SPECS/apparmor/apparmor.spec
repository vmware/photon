...
%exclude %{_prefix}%{_unitdir}/apparmor.service
...
%defattr(-,root,root)
%{_libdir}/python2.7/site-packages/apparmor-%{version}-py*.egg-info
%dir %{_libdir}/python2.7/site-packages/apparmor
%{_libdir}/python2.7/site-packages/apparmor/*
