...
%dir %config(noreplace) %{_sysconfdir}/apparmor.d/apache2.d
...
%dir %config(noreplace) %{_sysconfdir}/apparmor
%dir %config(noreplace) %{_sysconfdir}/apparmor.d
...
%dir %config(noreplace) %{_sysconfdir}/apparmor.d/abstractions
%config(noreplace) %{_sysconfdir}/apparmor.d/abstractions/*
%dir %config(noreplace) %{_sysconfdir}/apparmor.d/disable
%dir %config(noreplace) %{_sysconfdir}/apparmor.d/local
%dir %config(noreplace) %{_sysconfdir}/apparmor.d/tunables
