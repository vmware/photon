...
Vendor:		VMware, Inc.
Distribution:   Photon
Source0:	http://www.java.net/download/openjdk/jdk/jdk12/openjdk-%{version}.tar.gz
%define sha1 openjdk-12.0=49f62cd9943856ef16b6f32f9e14396653e79664
BuildArch:      x86_64
...
%define jdk_major_version 1.12.0
...
mv /usr/local/jvm/openjdk-12.0.2-internal/* %{buildroot}%{_libdir}/jvm/OpenJDK-%{jdk_major_version}/
...
%changelog
*   Fri Apr 17 2020 Tapas Kundu <tkundu@vmware.com> 12.0.2-1
