...
1. Verify that you have the following resources:
	...
	<td>Photon OS ISO or OVA file downloaded from VMware (<a href="https://packages-prod.broadcom.com/photon/4.0/GA/">https://packages-prod.broadcom.com/photon/4.0/GA/</a>).</td>
	</tr>
	</tbody>
	</table>
	</br>
...
1. Download Photon OS. Go to the following URL and download the latest release of Photon OS:
    ...
    [https://packages-prod.broadcom.com/photon/4.0/GA/](https://packages-prod.broadcom.com/photon/4.0/GA/)
