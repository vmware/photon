...
1. Download Photon OS. 
    ...
    **Note**: You cannot use the Photon ISO to install on RPi. 
    ...
    Go to the following URL and download the latest release of Photon OS image for RPi: [https://packages-prod.broadcom.com/photon/4.0/GA/rpi/rpi.tar.xz](https://packages.vmware.com/photon/4.0/GA/rpi/rpi.tar.xz). 
