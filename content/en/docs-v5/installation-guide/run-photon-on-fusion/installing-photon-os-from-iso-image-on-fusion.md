...
1. Power On the VM
    ...
    ![Photon OS installer](./installation-guide/images/bootscreen7.png)
    
    Press the Enter key on your keyboard to start installing.
    
    ![License](./installation-guide/images/license8.png)
...
1. Configure the Partition
    ...
    **Mountpoint** - Mount point for this partition.
    ...
    ![Disk erase](./installation-guide/images/erasedisk21.png)
...
1. Select an Installation Option
    ...
    ![Installation options](./installation-guide/images/flavorselection12.png)
...
1. Specify the System root Password
    ...
    ![Password](./installation-guide/images/rootpassword19.png)
    ...
    ![Confirmation](./installation-guide/images/installationcomplete22.png)

1. Reboot the VM and Log In

    Press any key on the keyboard and the virtual machine will reboot into Photon OS.
    
    ![Reboot](./installation-guide/images/splashscreen23.png)
