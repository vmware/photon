...
<p>2. Software utilities to flash an image onto an SD-card (details and instructions provided below).</td>
	...
	<td>Photon OS RPi image downloaded from <a href="https://packages-prod.broadcom.com/photon/">URL</a> <br> 
...
1. Download Photon OS. 
    ...
    **Note**: You cannot use the Photon ISO to install on RPi. 
    ...
    Go to the following URL and download the latest release of Photon OS image for RPi: [https://packages-prod.broadcom.com/photon/5.0/GA/rpi/rpi.tar.xz](https://packages-prod.broadcom.com/photon/5.0/GA/rpi/rpi.tar.xz). 
