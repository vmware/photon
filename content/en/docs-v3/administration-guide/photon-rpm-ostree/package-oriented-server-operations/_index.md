...
So what's in an RPMS repository? If we point the browser to https://packages-prod.broadcom.com/photon/3.0/photon_updates_3.0_x86_64, we can see there are three top directories:
