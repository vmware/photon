...
For example, the current GA revision of the 4.0 release would be located at the following URL: [https://packages-prod.broadcom.com/photon/4.0/GA/gce/](https://packages-prod.broadcom.com/photon/4.0/GA/gce/), and the 3.0 GA version would be located at: [https://packages-prod.broadcom.com/photon/3.0/GA/gce/](https://packages-prod.broadcom.com/photon/3.0/GA/gce/).
