...
class Installer(object):
    ...
    def get_size_of_packages(self):
        modules.commons.log(modules.commons.LOG_INFO, "Get all the infomations")
        modules.commons.log(modules.commons.LOG_INFO, "(?:^Name.*$)|(?:^.*Install Size.*$)")
        ...
        modules.commons.log(modules.commons.LOG_INFO, "Find the name time pairs")
        selected_packages = self.install_config['packages']
        self.size_of_packages = {}
        modules.commons.log(modules.commons.LOG_INFO, "In the function get_size_of_packages 2")
