    ...
    def execute_modules(self, phase):
        ...
        for mod_path in modules_paths:
            ...
            try:
                ...
                modules.commons.log(modules.commons.LOG_ERR, 'Error importing module {}'.format(module))
                continue
            ...
            if not hasattr(mod, 'install_phase'):
                modules.commons.log(modules.commons.LOG_ERR, "Error: can not defind module {} phase".format(module))
                continue
            ...
            if not hasattr(mod, 'execute'):
                modules.commons.log(modules.commons.LOG_ERR, "Error: not able to execute module {}".format(module))
                continue
