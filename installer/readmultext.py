...
class ReadMulText(Action):
    def __init__(self, maxy, maxx, y, install_config, field, display_string, confirmation_error_msg, 
        echo_char, accepted_chars, validation_fn, conversion_fn, default_string = None):
        self.maxy = maxy
        self.maxx = maxx
        self.y = y
        ...
        self.position = 0
        self.height = len(self.display_string) * 2 + 2
    ...
    def do_action(self):
        ...
        while True:
            ...
            ch = self.textwin.getch(self.y+2+self.position*2, curs_loc)
    ...
    def update_text(self):
        ...
        self.textwin.addstr(self.y+2+self.position*2, 1, text)      
